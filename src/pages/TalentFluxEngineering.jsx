...
export default function TalentFluxEngineering() {
  ...
  return (
    <div style={{ background: E.bg, color: E.text, fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
      ...
      {/* TESTIMONIALS */}
      <section style={{ padding: "64px 2rem", borderTop: `1px solid ${E.border}` }}>
        <div style={{ maxWidth: 1060, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 18 }}>
          {[
        ...
        <div style={{ maxWidth: 1060, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 16 }}>
            {[["Confidentialité", "/privacy"], ["CGU", "/cgu"], ["Contact", "/contact"]].map(([label, to]) => (
              <Link key={to} to={to} style={{ color: E.subtle, fontSize: ".7rem", textDecoration: "none", fontFamily: "'DM Mono', monospace", transition: "color .2s" }}
