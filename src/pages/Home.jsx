    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 14, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 10, flexShrink: 0 }}>
          <Link to={v.candidature} style={{ padding: "10px 18px", borderRadius: 11, background: v.bg, border: `1px solid ${v.border}`, color: v.accent, fontWeight: 700, fontSize: ".82rem", textDecoration: "none", display: "flex", alignItems: "center", gap: 7, transition: "all .2s", fontFamily: "'DM Sans',sans-serif" }}
            onMouseEnter={e => e.currentTarget.style.background = v.bg.replace(".06", ".12")}
            onMouseLeave={e => e.currentTarget.style.background = v.bg}>
            Postuler
          </Link>
          <Link to={v.path} style={{ padding: "10px 20px", borderRadius: 11, background: v.grad, border: "none", color: "#fff", fontWeight: 700, fontSize: ".82rem", textDecoration: "none", display: "flex", alignItems: "center", gap: 7, boxShadow: `0 4px 18px ${v.accent}35`, transition: "all .2s", fontFamily: "'DM Sans',sans-serif" }}
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 52, display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : isTablet ? "repeat(3,1fr)" : "repeat(6,1fr)", gap: 12 }}>
            {VERTICALS.map(v => {
              const Icon = v.icon;
              return (
                <Link key={v.key} to={v.path} style={{ textDecoration: "none", display: "flex", flexDirection: "column", alignItems: "center", gap: 8, padding: "18px 12px", borderRadius: 16, background: "rgba(255,255,255,.02)", border: "1px solid rgba(255,255,255,.06)", transition: "all .25s" }}
        ...
        <div style={{ maxWidth: 1120, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          ...
          <div style={{ display: isMobile ? "none" : "flex", gap: 18, flexWrap: "wrap" }}>
            {[["IT", "/it"], ["Finance", "/finance"], ["Ingénierie", "/ingenierie"], ["Paysagisme", "/paysagisme"], ["Télécom", "/telecom"], ["Pharma", "/pharma"]].map(([label, to]) => (
              <Link key={to} to={to} style={{ color: "#334155", fontSize: ".72rem", textDecoration: "none", transition: "color .2s" }} onMouseEnter={e => e.target.style.color = "#64748B"} onMouseLeave={e => e.target.style.color = "#334155"}>{label}</Link>
            ))}
